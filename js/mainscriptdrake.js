...
if (r<=0) {
    document.getElementById("resultat").innerHTML = "tu as 0% de chances de tenir 30s contre Nathan Drake";
}else if (r>=100) {
    document.getElementById("resultat").innerHTML = "tu as 100% de chances de tenir 30s contre Nathan Drake";
}

else{

document.getElementById("resultat").innerHTML = "tu as " + r + "% de chances de tenir 30s contre Nathan Drake";
