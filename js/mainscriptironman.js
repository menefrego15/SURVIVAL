...
var quo = 0;
var quo = (((100*sexe)+(80*weight)+(60*size)+(40*sports)+(20*age))*0.4)/300;
...
if (r<=0) {
    document.getElementById("resultat").innerHTML = "tu as 0% de chances de tenir 30s contre Iron Man";
}else if (r>=100) {
    document.getElementById("resultat").innerHTML = "tu as 100% de chances de tenir 30s contre Iron Man";
}

else{

document.getElementById("resultat").innerHTML = "tu as " + r + "% de chances de tenir 30s contre Iron man";
