...
var quo = 0;
var quo = (((100*sexe)+(80*weight)+(60*size)+(40*sports)+(20*age))*1.2)/300;
...
if (r<=0) {
    document.getElementById("resultat").innerHTML = "tu as 0% de chances de tenir 30s contre un zombie";
}else if (r>=100) {
    document.getElementById("resultat").innerHTML = "tu as 100% de chances de tenir 30s contre un zombie";
}

else{

document.getElementById("resultat").innerHTML = "tu as " + r + "% de chances de tenir 30s contre un zombie";
